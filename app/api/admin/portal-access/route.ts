 ...
 * Get list of merchant IDs with portal access from Salesforce
 */
export async function GET() {
  try {
    ...
    // Query Salesforce for merchants with portal access
    ...
    try {
      ...
      console.error('[Portal Access API] Error querying Salesforce:', error)
      return NextResponse.json({
        success: true,
        merchantIds: []
      })
    ...
    return NextResponse.json(
      {
        success: false,
        error: 'Failed to fetch portal access merchants',
